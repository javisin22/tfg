// File: C:\Users\JVS\tfg\fit-connect\app\layout.tsx
import * as entry from '../../../frontend/app/layout.js';
import type {
  ResolvingMetadata,
  ResolvingViewport,
} from 'next/dist/lib/metadata/types/metadata-interface.js';

type TEntry = typeof import('../../../frontend/app/layout.js');
...
if ('generateMetadata' in entry) {
  checkFields<
    Diff<LayoutProps, FirstArg<MaybeField<TEntry, 'generateMetadata'>>, 'generateMetadata'>
  >();
  checkFields<
    Diff<ResolvingMetadata, SecondArg<MaybeField<TEntry, 'generateMetadata'>>, 'generateMetadata'>
  >();
}
...
if ('generateViewport' in entry) {
  checkFields<
    Diff<LayoutProps, FirstArg<MaybeField<TEntry, 'generateViewport'>>, 'generateViewport'>
  >();
  checkFields<
    Diff<ResolvingViewport, SecondArg<MaybeField<TEntry, 'generateViewport'>>, 'generateViewport'>
  >();
}
